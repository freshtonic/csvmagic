    ...
    def self.run
      opts = Trollop::options do
        ...
        opt :exclude, 
          ...
          "Any rows matching this Ruby expression will be excluded from the
        ...
        opt :include, 
          ...
          "Any rows not matching this Ruby expression will be excluded from the
          output. Can be specified multiple times and will be ORed together.
          (cannot use --include with --exclude). ", 
        ...
        opt :save_excluded, 
          ...
          "Any rows excluded from the output will be saved to the file. The row
        ...
        opt :select, 
          ...
          "Comma-seperated list of columns to output. Each item in the list is
          a Ruby expression", 
        ...
        opt :in_place, 
          ...
          "Modify the input file in place. WARNING: this operation is
        ...
        opt :header, 
          ...
          "Treat the first line of the CSV file as a header that contains the
        ...
        opt :headings, 
          ...
          "Tells CSVMagic what the column names are so you can use the names in
        ...
        opt :output_header, 
          ...
          "Output the column names for all selected columns", 
          
          :default => false

        opt :input_encoding, 
          
          "The input encoding, e.g. ascii, UTF-8", 
          
          :type => String

        opt :output_encoding, 
          
          "The output encoding, e.g. ascii, UTF-8", 
          
          :type => String

        opt :input_delimiter, 
          
          "Column delimiter for the input", 
          
          :type => String, :default => ','

        opt :output_delimiter, 
          
          "Column delimiter for the output", 
        ...
        opt :require, 
          ...
          "Ruby files to require before processing. This enables the use of
        ...
        opt :eval, 
          ...
          "Ruby code to be evaluated before processing. Use this option to
